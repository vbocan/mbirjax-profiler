...
XProf tip: In the HLO Op Profile tool, turn OFF the "Exclude Idle" toggle.
The RTX A4000 uses GDDR6 (not HBM), so XProf cannot compute FLOPS utilization
and will classify ops as "idle" — toggling it off reveals the full op table.
